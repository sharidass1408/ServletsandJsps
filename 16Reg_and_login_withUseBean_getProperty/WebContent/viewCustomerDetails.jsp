...
<!-- The values inside the use bean tag will be used if user object does not exist in page, request, session, context scope -->
	<jsp:setProperty property="name" param="name" name="user" value="Default user"/>
</jsp:useBean>
